...
//         >
//           <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-900 border border-gray-800 mb-4">
...
//             Purpose-built, enterprise-ready solutions for education and dairy —
//             crafted for long-term reliability and delightful UX.
//           </p>
//         </motion.div>
...
//               </Button>
//               <Button variant="outline" className="border-gray-700 text-gray-300 hover:bg-gray-800 text-sm py-2 px-4">
//                 View Demo
//               </Button>
//             </div>
//           </motion.div>
...
//                 <StackCard
//                   customClass="max-w-[340px] w-[320px] h-[430px] rounded-2xl overflow-hidden transform-gpu hover:scale-[1.03] transition-transform duration-300 shadow-[0_12px_40px_rgba(0,0,0,0.55)] border border-transparent box-border"
//                 >
//                   {/* IMAGE (fixed aspect) */}
...
//                   {/* CONTENT (flex column fixed to available space) */}
...
//         {/* ===== New alternating product sections: info + device mock ===== */}
//         {/* MilkFly: left = device, right = info (reversed) */}
//         <motion.div
...
//         >
//           {/* Left: iPhone mock (milkfly) */}
//           <div className="order-1 lg:order-1 flex justify-center lg:justify-start">
//             <div className="max-w-[360px] w-full">
//               <Iphone15Pro
//                 className="w-[280px] h-auto"
//                 videoSrc="/milkTrack.mp4"   // must be in /public
//                 poster="/milkTrack-poster.jpg" // optional fallback poster
//                 variant="titanium"          // silver titanium
//                 fit="cover"
//                 shadow={0.6}                 // cover (crop) or contain (fit with bars)
//               />
//             </div>
//           </div>
...
//             <div className="bg-gradient-to-br from-gray-900/70 to-gray-900/60 border border-gray-800 rounded-2xl p-6 shadow-lg">
...
//                   <p className="text-blue-400 text-xs">Farm-to-door dairy operations</p>
//                 </div>
//               </div>
...
//                   <Button variant="outline" className="border-gray-700 text-gray-300 hover:bg-gray-800 text-sm py-2 px-4">Request Demo</Button>
...
//               <Image
//                 src="./macbook.png" // place inside /public
//                 alt="EduFly MacBook Mock"
//                 width={720}   // doubled width
//                 height={480}  // doubled height (adjust as per your PNG ratio)
//                 className="w-full h-auto drop-shadow-2xl"
//                 priority // ensures faster loading since it’s above the fold
//               />
//             </div>
//           </div>
//         </motion.div>
