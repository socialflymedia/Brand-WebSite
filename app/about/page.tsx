...
>
        ...
        >
          ...
          <motion.div variants={fadeIn("left", 0.3)}>
            ...
            <p className="text-muted-foreground mb-6">
              At SocialFly Networks, our mission is to democratize access to advanced AI technologies for businesses of all sizes. We believe that artificial intelligence should be accessible, understandable, and most importantly, actionable.
            </p>
        ...
        >
          ...
          <p className="text-muted-foreground">
            Today, SocialFly Networks serves clients across various industries, from education and healthcare to finance and retail. Our team has grown to include experts in machine learning, data science, software development, and business strategy, all united by a common goal: to make AI accessible, understandable, and impactful for our clients.
          </p>
        </motion.div>
      </div>
    </div>
