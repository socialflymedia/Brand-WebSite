...
const POSTS = [
  { slug: "nextjs-seo-2025", title: "Next.js SEO in 2025 — Practical Checklist", excerpt: "What works today for LCP, SSR and structured data.", date: "2025-07-12", image: "/blog/nextjs-seo.jpg" },
  { slug: "pwa-performance", title: "PWA Performance Patterns", excerpt: "Patterns to make PWAs feel instantly responsive.", date: "2025-05-01", image: "/blog/pwa-performance.jpg" },
  { slug: "marketing-local-business", title: "Local Marketing for Mawana Businesses", excerpt: "Tactical checklist for local visibility and conversions.", date: "2025-02-20", image: "/blog/local-marketing.jpg" }
];
...
export default function BlogIndex() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(blogStructured) }} />
      <section className="pt-28 pb-12 bg-black">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-6">
              <a href="/resources/rss.xml" className="text-orange-400 underline">RSS feed</a>
            </div>
          </div>
            ...
            {POSTS.map((p) => (
              <article key={p.slug} className="bg-gray-950 border border-gray-800 rounded-2xl overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4">
                    <Link href={`/resources/blog/${p.slug}`} className="text-orange-400 font-semibold">Read →</Link>
                  </div>
                </div>
              </article>
            ))}
